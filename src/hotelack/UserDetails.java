	...
	{ 	
		...
		{  if(ad<=2 && cd<=2)
			{System.out.println("1 Ac room Allocated \t your Bill=₹"+b1);}
				...
				sad=ad-2;b1+=(sad/2)*b1;
				System.out.println(1+(sad/2)+" Ac rooms allocat"
					+ "ed \t your Bill=₹"+b1);}
		}
		else if(rtp==2)
		{
			if(ad>=3 && cd>=3)
				...
				sad=ad-2;b2+=(sad/2)*b2;
				System.out.println(1+(sad/2)+" NoN Ac rooms allocated \t your Bill=₹₹₹"+b2);}
		}
		...
		{  if(ad<=2 && cd<=2)
			{System.out.println("1 Ac room Allocated \t your Bill=₹"+b3);}
				...
				sad=ad-2;b3+=(sad/2)*b3;
				System.out.println(1+(sad/2)+" Ac rooms allocated \t your Bill=₹"+b3);}
		}
		else if(rtp==2)
		{
			if(ad>=3 && cd>=3)
				...
				sad=ad-2;b4+=(sad/2)*b4;
				System.out.println(1+(sad/2)+" NON Ac rooms allocated \t your Bill=₹"+b4);}
		}
		else {System.out.println("invalid input..!");}													
		break;
